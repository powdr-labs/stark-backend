...
extern "C" {
    ...
    // Batched coset-parallel round0 kernels
...
/// Batched coset-parallel zerocheck evaluation for multiple small AIRs.
#[allow(clippy::too_many_arguments)]
pub unsafe fn zerocheck_ntt_eval_constraints_batched(
    tmp_sums_buffer: &mut DeviceBuffer<EF>,
    output: &mut DeviceBuffer<EF>,
    metas: &DeviceBuffer<u8>, // ZerocheckBatchMeta as raw bytes
...
/// Batched coset-parallel logup evaluation for multiple small AIRs.
#[allow(clippy::too_many_arguments)]
pub unsafe fn logup_bary_eval_interactions_round0_batched(
    tmp_sums_buffer: &mut DeviceBuffer<Frac<EF>>,
    output: &mut DeviceBuffer<Frac<EF>>,
    metas: &DeviceBuffer<u8>, // LogupBatchMeta as raw bytes
    air_for_block: &DeviceBuffer<u32>,
    segment_offsets: &DeviceBuffer<u32>,
    num_airs: u32,
    total_x_blocks: u32,
